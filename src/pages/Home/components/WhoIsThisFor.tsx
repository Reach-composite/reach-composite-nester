const WhoIsThisForSection = () => {
  return (
    <section className="py-12 bg-e6f6a5">
      <div className="container mx-auto px-4">
        <h2
          className="text-3xl md:text-4xl font-bold text-center mb-6"
          style={{ color: "#a61042" }}
        >
          Who is REACH Composites Nester for?
        </h2>

        <p className="text-center text-muted-foreground mb-10 max-w-3xl mx-auto">
          REACH Composites Nester is designed for industries and teams that work
          with composite materials and want to reduce waste, optimize material
          usage, and improve manufacturing efficiency.
        </p>
