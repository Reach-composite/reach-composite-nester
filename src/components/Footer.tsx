...
const Footer = () => {
  const footerLinks = [
    { label: "About REACH Composites Nester", path: "/about" },
    { label: "Benefits of REACH Composites Nester", path: "/benefits" },
    { label: "REACH Composites Nester Images", path: "/rmmimages" },
    {
          ...
          <div>
            ...
            <div className="mt-6 space-y-4">
              ...
              >
                <img
                  src={whatsappIcon}
                  alt="WhatsApp icon for contacting REACH Composites Nester support"
                  className="w-8 icon-a03359"
                />
                <span className="text-gray-300 text-lg">
                  +91 84592 78496
